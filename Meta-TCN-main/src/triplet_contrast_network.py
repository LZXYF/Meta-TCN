...
from tools.params import parse_args, print_args, set_seed
...
def main():
    ...
    out_dir = os.path.abspath(os.path.join(
        os.path.curdir,
        args.savepath))
    model['G'].load_state_dict(torch.load(out_dir + ".G"))
    test_acc, test_std = test(test_data, class_names, None, model, criterion, args, args.test_epochs, False)
